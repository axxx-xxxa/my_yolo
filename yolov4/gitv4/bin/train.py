...
def get_anchors(anchors_path):
    ...
    print(anchors)
    #return np.array(anchors).reshape([3,-1,2])[:,::-1,:]
...
def fit_one_epoch(net,yolo_losses,epoch,epoch_size,epoch_size_val,gen,genval,Epoch,cuda):
    ...
    if epoch % 9 == 0:
      torch.save(model.state_dict(), 'logs/Epoch%d-3Classes-newAnchors-0417-Total_Loss%.4f-Val_Loss%.4f.pth'%((epoch+1),total_loss/(epoch_size+1),val_loss/(epoch_size_val+1)))
...
if __name__ == "__main__":
    ...
    #------------------------------------------------------#
    #------------------------------------------------------#
    print(len(anchors[0]), num_classes)
    ...
    #model_path = "logs/Epoch91-3Classes-newAnchors-Total_Loss7.7511-Val_Loss6.0215.pth"
    ...
    #----------------------------------------------------#
    #----------------------------------------------------#
    #annotation_path = 'VOCdevkit/trainval_train.txt'
